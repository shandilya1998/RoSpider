...
// control inputs Control input is the tonic input required by oscillators to drive the oscillations
float W=3.5, R=0.3, X=0; // common control inputs frequency/amplitude/offset of the joints
float cW[N]={PI, PI, PI, PI};	// OHMEGAi - desired frequency rad/s.
float cR[N]={PI/2, PI/2, PI/2, PI/2 };	// Ri - desired amplitude in radians.
